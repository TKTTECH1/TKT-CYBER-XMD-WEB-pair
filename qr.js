              ...
              if (qr) await res.end(await QRCode.toBuffer(qr));
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let desc = `*Hey there, TKT-CYBER-XMD User!* 👋🏻

Thanks for using *TKT-CYBER-XMD* — your session has been successfully created!
...
> *© Powered by TKT-TECH*
for any help dm https://wa.me/263718095555 ✌🏻`;
                        await sock.sendMessage(sock.user.id, {
text: desc,
contextInfo: {
externalAdReply: {
title: "𝐓𝐊𝐓-𝐂𝐘𝐁𝐄𝐑𓃵 -𝐗M D 𝕮𝖔𝖓𝖓𝖊𝖈𝖙𝖊𝖉",
