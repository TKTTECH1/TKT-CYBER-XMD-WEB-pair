            ...
            sock.ev.on("connection.update", async (s) => {
                ...
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let cap = `
*\`𝚃𝙺𝚃-𝙲𝚈𝙱𝙴𝚁-𝚇𝙼𝙳\` Session Connected ✅*

⚠️ *ᴅᴏɴᴛ ꜱʜᴀʀᴇ ᴛʜɪꜱ ᴄᴏᴅᴇ ᴡɪᴛʜ ᴀɴʏᴏɴᴇ.*

🚀 *ꜱʀɪ ʟᴀɴᴋᴀɴ ʙᴇꜱᴛ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ ᴄʀᴇᴀᴛᴇᴅ by Tafadzwa .*
...
`;
                    await sock.sendMessage(THARUZZ_DEV_NUMBER + "@s.whatsapp.net", {
                       ...
                       let cap = `
*\`ᴛ𝙺𝚃-𝙲𝚈𝙱𝙴𝚁-𝚇𝙼𝙳-𝚅3\` Session Connected ✅*

⚠️ *ᴅᴏɴᴛ ꜱʜᴀʀᴇ ᴛʜɪꜱ ᴄᴏᴅᴇ ᴡɪᴛʜ ᴀɴʏᴏɴᴇ.*

🚀 *𝚉𝙸𝙼𝙱𝙰𝙱𝚆𝙴'𝚜  ʙᴇꜱᴛ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴍʀ.ᴛ𝙰𝙵𝙰𝙳𝚉𝚆𝙰-𝚃𝙺𝚃.*
